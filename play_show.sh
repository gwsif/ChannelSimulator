...
if [ $CS_CONF_LOAD_STATE -eq 1 ];
    then
        echo "[INFORMATION] SHOW SCRIPT ANNOUNCES CONF LOAD SUCCESS!"
    else
...
echo "FROM PLAY SHOW.SH - CS_SHOW_DIR is $CS_SHOW_DIR"
...
"$1"/display_video.sh "$CS_SHOW_SELECTED" "$CS_SHOW_DIR" "$1"
